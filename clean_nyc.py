...
ri_zipcodes_file = "./crawl/zip_codes_nyc.txt"
ri_business_path = "./raw_data/businesses/nyc"
ri_reviews_path = "./raw_data/reviews/nyc"

ri_zipcodes = open(ri_zipcodes_file, "r").read().split('\n')

b_output_path = "./businesses_nyc.csv"
r_output_path = "./reviews_nyc.csv"
