...
ri_zipcodes_file = "./crawl/zip_codes_ri.txt"
ri_business_path = "./raw_data/businesses/ri"
ri_reviews_path = "./raw_data/reviews/ri"

ri_zipcodes = open(ri_zipcodes_file, "r").read().split('\n')

b_output_path = "./businesses.csv"
r_output_path = "./reviews.csv"
